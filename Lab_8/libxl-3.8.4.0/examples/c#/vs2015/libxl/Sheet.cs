...
namespace libxl
{
    public class Sheet
    {
        ...
        public void insertCol(int colFirst, int colLast, bool updateNamedRanges)
        {
            xlSheetInsertCol(handle, colFirst, colLast, updateNamedRanges ? 1 : 0);
        }
        ...
        public void insertRow(int rowFirst, int rowLast, bool updateNamedRanges)
        {
            xlSheetInsertRow(handle, rowFirst, rowLast, updateNamedRanges ? 1 : 0);
        }
        ...
        public void removeCol(int colFirst, int colLast, bool updateNamedRanges)
        {
            xlSheetRemoveCol(handle, colFirst, colLast, updateNamedRanges ? 1 : 0);
        }
        ...
        public void removeRow(int rowFirst, int rowLast, bool updateNamedRanges)
        {
            xlSheetRemoveRow(handle, rowFirst, rowLast, updateNamedRanges ? 1 : 0);
        }
        ...
        [DllImport("libxl.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        private static extern void xlSheetInsertCol(IntPtr handle, int colFirst, int colLast, int updateNamedRanges);

        [DllImport("libxl.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        private static extern void xlSheetInsertRow(IntPtr handle, int rowFirst, int rowLast, int updateNamedRanges);

        [DllImport("libxl.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        private static extern void xlSheetRemoveCol(IntPtr handle, int colFirst, int colLast, int updateNamedRanges);

        [DllImport("libxl.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        private static extern void xlSheetRemoveRow(IntPtr handle, int rowFirst, int rowLast, int updateNamedRanges);
